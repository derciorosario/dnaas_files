...
<head>
  ...
  <title>Cobertura de Saneamanto - DNAAS</title>
...
<div class="_main-slider _sub">
	<div class="_slides">
		<div class="_slide s1"  style="background-image: url(../../images/others/9.jpg);background-position-y: 50%;">
			<div class="fill" _ed_hover_border  onclick="_ed_change_bottom_img(this.parentElement)"></div>
			<div class="_text_sub" _ed_editable>Cobertura de Saneamento</div>
		</div>
	</div>
</div>
...
<h3 class="__sub-title" _ed_editable>Cobertura de Saneamento Rural</h3>

<div class="_center_image">
	<img onclick="_ed_change_img(this)" src="../../images/others/cobertura_em_saneamento_rural.png">
</div>

<div style="height: 50px"></div>

<h3 class="__sub-title" _ed_editable>Cobertura de Saneamento Urbano</h3>
<div class="_center_image">
	<img onclick="_ed_change_img(this)" src="../../images/others/cobertura_em_saneamento_urbano.png">
</div>
