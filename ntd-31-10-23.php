...
<div class="_news">
	 <div class="content" style="margin-bottom: 0">
		<div class="_n">
			<h2 _ed_editable="">GOVERNO REALIZA INVESTIMENTOS ROBUSTOS NO SANEAMENTO URBANO EM MOÇAMBIQUE</h2>
			<div class="image">
				<img onclick="_ed_change_img(this)" src="uploaded_imgs/tt31.jpg">
				<div class="date">
				<span _ed_editable="">31 de Outbro de 2023</span>
		     	</div>
			</div>
...
O Governo, com financiamento do Banco Mundial, está a fazer investimentos robustos no Saneamento Urbano em Moçambique, como é o caso da reabilitação e expansão da Estação de Tratamento de Águas Residuais (ETAR) de Infulene em Maputo, incluindo intervenções na rede de esgotos da cidade. Para Além da ETAR de Infulene, o Governo, através do Projecto de Saneamento Urbano, deverá fazer intervenções em infraestruturas de saneamento em Tete e Quelimane.</p>
