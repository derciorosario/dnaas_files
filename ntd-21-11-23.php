...
<div class="_news">
	 <div class="content" style="margin-bottom: 0">
		<div class="_n">
			<h2 _ed_editable="">MAPUTO: MAIS DE 9 KM DE ESGOTO SERÃO REABILITADOS E LIGADOS À ETAR DE INFULENE
</h2>
			<div class="image">
				<img onclick="_ed_change_img(this)" src="uploaded_imgs/tt21.jpg">
				<div class="date">
				<span _ed_editable="">21 de Novembro de 2023</span>
		     	</div>
			</div>
...
Realizou-se na manhã desta segunda-feira, 20 de Novembro, a reunião inicial entre a AIAS, empreiteiro, fiscal e outras partes afectadas pelas obras de reabilitação da rede de esgotos da cidade de Maputo. No total, serão contruídos e reabilitados 9.4 km da rede de esgotos da cidade, que estarão conectados à Estação de Tratamento de Águas Residuais de Infulene, que se encontra na sua fase final de reabilitação e expansão. 
Para além de intervenções na rede, os trabalhos também deverão incluir a reabilitação de duas estações de Bombagem de esgotos, bem como a melhoria de mais de 3 mil ligações domiciliares à rede. A obra será executada pela CHICO Group, num valor global de cerca de 167 milhões de meticais. 
A rede de esgotos e a Estação de Tratamento de Águas Residuais de Infulene, serão intervencionadas como parte das actividades do Projecto de Saneamento Urbano (PSU), que visa aumentar o acesso aos serviços seguros de saneamento e melhorar a capacidade dos municípios de prover serviços de saneamento. O PSU é uma iniciativa do Governo de Moçambique, com financiamento do banco Mundial, abrangendo os Municípios de Maputo, Beira, Nampula, Tete e Quelimane. </p>
