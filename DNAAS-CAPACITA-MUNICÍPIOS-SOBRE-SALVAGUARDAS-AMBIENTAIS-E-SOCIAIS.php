...
<div class="_news">
	 <div class="content" style="margin-bottom: 0">
		<div class="_n">
			<h2 _ed_editable="">DNAAS CAPACITA MUNICÍPIOS SOBRE SALVAGUARDAS AMBIENTAIS E SOCIAIS</h2>
			<div class="image">
				<img onclick="_ed_change_img(this)" src="uploaded_imgs/tt08.jpg">
				<div class="date">
				<span _ed_editable="">08 de Agosto de 2023</span>
		     	</div>
			</div>
...
<p _ed_editable="" class="_ed _ed_item" _ed_model="_ed_model_option_5">&nbsp;<span style="background-color: transparent;">A DNAAS - Direcção Nacional de Abastecimento de Água e Saneamento realiza, de 7 a 9 de Agosto, a capacitação de técnicos dos serviços municipais de Saneamento, sobre procedimentos e instrumentos de salvaguardas sociais e ambientais a serem implementados durante a implementação dos diversos sub-projectos ao nível dos municípios. O Treinamento envolve técnicos dos serviços Municipais de saneamento dos Municípios de Maputo, Beira, Tete, Quelimane e Nampula beneficiários do Projecto de Saneamento Urbano (PSU)</span><div><br><div>A capacitação visa dotar os participantes de conhecimentos sobre procedimentos e normas ambientais e socias a serem tomadas em consideração por forma a garantir a protecção do meio ambiente bem como assegurar que a vida das comunidades circunvizinhas às áreas de implementação dos projectos não sejam negativamente afectados durante a implementação dos projectos em curso nos Municípios.</div><div>Para além das sessões teóricas na sala, está prevista uma componente de visita de campo à Estação de Tratamento de Águas Residuais ETAR de Infulene e ao Departamento de Abastecimento de Água e Saneamento de Maputo, para troca de experiências sobre a implementação de instrumentos de salvaguardas ambientais e sociais.</div><div><br></div><div>A capacitação é coordenada pelos especialistas de salvaguardas da DNAAS e AIAS, com apoio de técnicos da Direcção Nacional do Ambiente, da Direcção Nacional de Desenvolvimento Territorial e da Inspeção Geral do Trabalho, decorre sob o lema: “Implementação do PSU no Contexto das Normas Ambientais e Sociais (NAS) do Banco Mundial e da Legislação Nacional”.</div><div>O PSU tem como objectivo aumentar o acesso aos serviços de Saneamento com gestão segura, através de investimentos em construção de estações de tratamento de águas residuais, rede de esgotos, de Saneamento Urbano, sanitários públicos e domiciliares, aquisição de equipamentos, capacitação técnica, entre outras actividades.</div></div></p>
