...
<head>
  ...
  <title>Missão, Visão e Valores - DNAAS</title>
...
<div class="_main-slider _sub">
	<div class="_slides">
		<div class="_slide s1" style="background-image: url(../../images/_main/3.JPG);background-position-y: 19%">
			...
			<div class="_text_sub" _ed_editable>Missão, Visão e Valores</div>
		</div>
	</div>
</div>
...
<div class="_two_column_div">
	<div class="_flex">
		...
		<div class="text">
			<h3 _ed_editable class="_ed _ed_item" _ed_model="_ed_model_option_5">Missão</h3>
<p _ed_editable class="_ed _ed_item" _ed_model="_ed_model_option_5">Garantir o desenvolvimento do Sector de Abastecimento de Água e Saneamento, através do fortalecimento de capacidades para a gestão sustentável e um acesso universal a serviços de água e saneamento.</p>			

<h3 _ed_editable class="_ed _ed_item" _ed_model="_ed_model_option_5">Visão</h3>
<p  _ed_editable class="_ed _ed_item" _ed_model="_ed_model_option_5">Autoridade catalisadora e dinamizadora do desenvolvimento e gestão integrada e sustentável dos serviços de abastecimento de água e saneamento e de todos os actores que para esse fim contribuem.</p>


		</div>
		<div class="image">
			<img src="../../images/others/1.JPG"  onclick="_ed_change_img(this)">
		</div>
...
<div class="_list_div">
	<div class="content" >
		<h4 _ed_editable class="_ed _ed_item" _ed_model="_ed_model_option_5">Valores</h4>
		<div  class="_div _ed _ed_item" _ed_model="_ed_model_option_5">
			<div class="_line_left">
			</div> 
			<span class="text" _ed_editable>Harmonia e Alinhamento</span>
		</div>
		<div class="_div _ed _ed_item" _ed_model="_ed_model_option_5">
			<div class="_line_left">
			</div> 
			<span class="text" _ed_editable>Transparência</span>
		</div>
		<div class="_div _ed _ed_item" _ed_model="_ed_model_option_5">
			<div class="_line_left">
			</div> 
			<span class="text" _ed_editable>Espírito de Equipa e Respeito Mútuo</span>
		</div>
		<div class="_div _ed _ed_item" _ed_model="_ed_model_option_5">
			<div class="_line_left">
			</div> 
			<span class="text" _ed_editable>Comprometimento e Profissionalismo</span>
		</div>
		<div class="_div _ed _ed_item" _ed_model="_ed_model_option_5">
			<div class="_line_left">
			</div> 
			<span class="text" _ed_editable>Dinamismo e Inovação</span>
		</div>
		<div class="_div _ed _ed_item" _ed_model="_ed_model_option_5">
			<div class="_line_left">
			</div> 
			<span class="text" _ed_editable>Atitude de Melhor Servir</span>
		</div>
